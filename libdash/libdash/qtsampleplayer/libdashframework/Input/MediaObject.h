...
namespace libdash
{
    namespace framework
    {
        namespace input
        {
            ...
            {
                public:
                    MediaObject             (dash::mpd::ISegment *segment, dash::mpd::IRepresentation *rep, int k=0);
                    virtual ~MediaObject    ();
                    ...
                    std::string& AbsoluteURI() { dash::network::IChunk *chunk = this->segment; return chunk->AbsoluteURI(); };
