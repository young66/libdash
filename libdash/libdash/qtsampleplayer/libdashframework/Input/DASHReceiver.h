...
namespace libdash
{
    namespace framework
    {
        namespace input
        {
            ...
            {
                public:
                DASHReceiver            (dash::mpd::IMPD *mpd, IDASHReceiverObserver *obs, buffer::MediaObjectBuffer *buffer, uint32_t bufferSize, int k=0);
                ...
                private:
                    ...
                    int k;
                    uint32_t beacon;
                    dash::mpd::IRepresentation *pushRepresentation;
                    mpd::IRepresentationStream *pushRepresentationStream;
            };
        }
    }
}
