...
public:
    ...
    void setupUi(QMainWindow *QtSamplePlayerClass)
    {
        ...
        label_k = new QLabel(w_boxes);
        label_k->setObjectName(QStringLiteral("label_k"));

        verticalLayout_2->addWidget(label_k);

        cb_k = new QComboBox(w_boxes);
        cb_k->setObjectName(QStringLiteral("cb_k"));

        verticalLayout_2->addWidget(cb_k);
    ...
    void retranslateUi(QMainWindow *QtSamplePlayerClass)
    {
        ...
        cb_mpd->insertItems(0, QStringList()
         << QApplication::translate("QtSamplePlayerClass", "https://localhost:8444/vod/counter.mpd", 0)
         << QApplication::translate("QtSamplePlayerClass", "https://localhost:8444/vod2/counter.mpd", 0)
         << QApplication::translate("QtSamplePlayerClass", "https://localhost:8444/bunny/big_buck_bunny_480.mpd", 0)
        ...
        lineEdit_mpd->setText(QApplication::translate("QtSamplePlayerClass", "https://localhost:8444/vod2/counter.mpd", 0));
        ...
        label_k->setText(QApplication::translate("QtSamplePlayerClass", "K", 0));
